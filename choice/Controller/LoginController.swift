...
class LoginController: UIViewController {
    ...
    let nameSeparatorView: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor(r: 209, g: 209, b: 209)
        view.translatesAutoresizingMaskIntoConstraints = false
        return view
    }()
    ...
    //Toggle between registration and entry.
    ...
    func setupProfileImageView() {
        ...
        profileImageView.bottomAnchor.constraint(equalTo: loginRegisterSegmentedControl.topAnchor, constant: -102).isActive = true
